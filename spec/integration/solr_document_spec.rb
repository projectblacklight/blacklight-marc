...
def get_hash_with_bad_marcxml
  ...
  describe SolrDocument do
    ...
    before(:each) do
      ...
      SolrDocument.extension_parameters[:marc_source_field]  = :marc_ss
      ...
      SolrDocument.use_extension( Blacklight::Solr::Document::Marc ) { |document| document.has_key?(:marc_ss)}
